...
from open_r1.utils.trainer_utils import profiling_context
...
class DiffuGRPOTrainer(GRPOTrainer):
    ...
    def _generate_and_score_completions(
        ...
        if self.args.random_masking:
            ...
            mask_seeds = random.choices(list(range(0, 2**12)), k = self.num_iterations)
        ...
        with torch.no_grad():
            ...
            if self.beta == 0.0:
                ...
                if self.lora:
                    ...
                    all_ref_per_token_logps = self._get_per_token_logps(self.ref_model, prompt_completion_ids_expanded, logits_to_keep, mask_seeds)
